...
Installing "ok-panel" can be done either by searching for "ok-panel" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
